...
[![tests: 11](https://img.shields.io/badge/tests-11-brightgreen?style=flat)](test/)
...
The suite currently has **11 tests** and **6 public tasks**. CI runs on **ubuntu-latest + macos-latest**.
